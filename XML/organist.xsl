...
<xsl:template match="/">
  <table border="1" rules="none" cellspacing="5" cellpadding="5" align="center">
      <tr>
      	<td/>
        <td><i><font size="+2"><xsl:value-of select="organist/fullName"/></font></i></td>
      </tr>
      ...
      <xsl:if test="string(organist/wf)">
        <tr>
          <th align="right" valign="top">Weddings/Funerals</th>
          <td><xsl:value-of select="organist/wf"/></td>
        </tr>
      </xsl:if>
            <tr>
    ...
    <xsl:if test="string(organist/email)">
      <tr>
    ...
    <xsl:if test="string(organist/travel)">
      <tr>
        <th align="right" valign="top">Travel Area</th>
        <td width="500"><xsl:value-of select="organist/travel"/></td>
      </tr>
    </xsl:if>
    <tr>
      <th align="right" valign="top">Information</th>
      <td width="500"><xsl:value-of select="organist/details"/></td>
    </tr>
  </table> 
</xsl:template>
