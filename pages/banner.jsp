...
<logic:present name="user">
  ...
  </td><td><a href="mailto:bassooner@gmail.com">Email the Webmaster</a><br><font color="#82accd" size="-3">v2.1.1</font></td></tr>
</logic:present>
<logic:notPresent name="user">
  <tr>
    ...
    </td><td><a href="mailto:bassooner@gmail.com">Email the Webmaster</a><br><font color="82accd" size="-3">v2.1.1</font></td>
  </tr>
</logic:notPresent>
</table>
